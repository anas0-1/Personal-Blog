                ...
                try {
                    ...
                    if ($stmt->rowCount() > 0) {
                        ...
                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                            echo "<tr>";
                            echo "<th scope='row'>" . $row["Idarticle"] . "</th>";
                            echo "<td>" . $row["title"] . "</td>";
                            echo "<td>" . $row["Content"] . "</td>";
                            echo "<td>";
                            echo "<a href='post-delete.php?Idarticle=" . $row["Idarticle"] . "' class='btn-btn btn-danger'>Delete</a>";
                            echo "<a href='post-edit.php?Idarticle=" . $row["Idarticle"] . "' class='btn-btn btn-warning'>Edit</a>";
                            echo "</td>";
                            echo "</tr>";
                        }
                    } else {
